// Only use modified_database generated with modified_initDB (database seeder script) with this file
...
(async () => {
  db = await open({
    filename: './Parth_Tiwari_BD_4_Assignment_1/modified_database.sqlite',
...
app.get('/restaurants/filter', async (req, res) => {
  try {
    let isRestoVeg = req.query.isVeg === 'true';
    let hasRestoOutSeating = req.query.hasOutdoorSeating === 'true';
    let isRestoLuxury = req.query.isLuxury === 'true';
    console.log(isRestoVeg);
    console.log(hasRestoOutSeating);
    console.log(isRestoLuxury);
...
app.get('/dishes/filter', async (req, res) => {
  try {
    let isDishVeg = req.query.isVeg === 'true';
